...
export default function CustomDropdown(props) {
  ...
  return (
    <div>
      <div>
      {avatarIcon ? <Avatar style={{margin: '8px'}} onClick={handleClick} >{avatarIcon}</Avatar> :
        <Button
                    ...
                    return (
                      <div style={{display: 'block'}}> 
                        <div className={classes.secondaryText}>
                         <img width='20px' height='20px' src={require('../../assets/img/countries/india.png')} alt=""/> {prop[1]}</div>
                        <MenuItem
                          key={key}
                          onClick={() => handleClose(prop)}
                          className={dropdownItem}
                        >
                          <ButtonCore  color="primary" variant="outlined"
                          key={key}
                          onClick={() => handleClose(prop)}
                        >{prop[0]}</ButtonCore>
                          <ButtonCore color="primary" variant="outlined"
